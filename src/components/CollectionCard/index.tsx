...
function CollectionCard() {
  return (
    <div className={styles.container}>
      <img
        src="https://images.unsplash.com/photo-1564419320603-628d868a193f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=398&q=80"
        alt="ad"
      />
      ...
      <div className={styles.textWrapper}>
        <div>
          <h5>No Limits</h5>
          <p className={styles.musicianName}>John watts</p>
        </div>
